...
class TodoList {
    ...
    func move(_ item: ChecklistItem, from sourcePriority: Priority, at sourceIndex: Int, to destinationPriority: Priority, at destinationIndex: Int) {
...
//    }
    ...
    private func randomTitle() -> String {
        ...
        var titles = ["New todo item", "Generic todo", "Fiil me out", "I need smth to do", "Much todo about nothing"]
